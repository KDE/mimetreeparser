...
QVariant AttachmentModel::data(const QModelIndex &index, int role) const
{
    ...
    case IsEncryptedColumn:
        ...
        case Qt::CheckStateRole:
            return (bool)part->encryptionPart(MimeTreeParser::Core::RecurseMode::FullRecursion) ? Qt::Checked : Qt::Unchecked;
        default:
            return {};
        }
    case IsSignedColumn:
        switch (role) {
        case Qt::CheckStateRole:
            return (bool)part->signaturePart(MimeTreeParser::Core::RecurseMode::FullRecursion) ? Qt::Checked : Qt::Unchecked;
        default:
            return {};
        }
    default:
